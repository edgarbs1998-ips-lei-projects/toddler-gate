...
import com.toddlergate.internal.ActivityLifeCycleHandler;
import com.toddlergate.internal.PianoReactPackage;
...
public final class ReactNative {
     ...
     */
    public static View createPianoView(@NonNull Activity activity, boolean useDeveloperSupport) {
        ...
        if (reactInstanceManager == null) {
            reactInstanceManager = ReactInstanceManager.builder()
                    ...
                    .addPackage(new PianoReactPackage())
